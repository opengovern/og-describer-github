...
func GitHubWorkflowFileContent(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
	...
	if err != nil {
		...
		// The API throws "404 No commit found" error if there is any dynamic workflow file generated by GitHub action.
		// https://github.com/nextstrain/status/issues/6
		// https://github.com/nextstrain/status/pull/7/commits/160eb950235ae81d3d37a990a0715ed815cd7fc9
